...
public class Game {
    ...
    public void updatePlayerScore(PlayerType playerType, int points) {
        String playerName = playerType.toString();
        int currentScore = leaderboard.getOrDefault(playerName, 0);
        int newScore = currentScore + points;
        leaderboard.put(playerName, newScore);
        System.out.println(playerName + " scored " + points + " points. Total score: " + newScore);
        // Optionally, you can broadcast the updated leaderboard to all players
        broadcastLeaderboard();
    }

    // Method to broadcast the updated leaderboard
