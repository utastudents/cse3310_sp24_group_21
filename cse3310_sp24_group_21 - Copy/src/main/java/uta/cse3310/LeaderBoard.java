...
public class LeaderBoard {
    ...
    public void addScore(String playerName, int score) {
     ...
     private void broadcastLeaderboardUpdate() {
        // Create a JSON representation of the leaderboard
        Gson gson = new Gson();
        String leaderboardJson = gson.toJson(scores);

        // Broadcast the leaderboard JSON to all connected clients
        // You should implement this method based on your WebSocket server logic
        // Example: App.broadcast(leaderboardJson);
    }
