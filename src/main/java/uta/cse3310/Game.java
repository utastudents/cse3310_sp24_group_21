...
public class Game {
    ...
    public void selectWord(String selectedWord, PlayerType playerType) {
        // Assuming selectedWord contains the word selected by the player
    
        // Assign 1 point to the player for each selected word
        int points = 1;
    
        // Assign points to the player in the leaderboard
        addToLeaderboard(playerType.toString(), points);
    
        // Other actions related to selecting a word...
    }
    
    private void addToLeaderboard(String playerName, int points) {
        // Add the points to the leaderboard for the specified player
